...
const DRAFT_TEXT={
 conflict:['別のタブで更新されています。書きかけを残して最新の状態を読み直してください。','Another tab updated your data. Reload the latest state while keeping your draft.','दूसरे टैब में डेटा बदला है। मसौदा रखते हुए नया डेटा लोड करें।','다른 탭에서 변경됐어요. 초안을 남기고 최신 내용을 불러오세요.','其他标签页已更新数据。保留草稿并读取最新状态。','Otra pestaña cambió los datos. Carga el estado actual conservando el borrador.','Un autre onglet a modifié les données. Rechargez en conservant le brouillon.'],
 latest:['最新の状態を読み直す','Load latest state','नया डेटा लोड करें','최신 내용 불러오기','读取最新状态','Cargar estado actual','Charger les dernières données'],
 error:['保存できませんでした。この画面に文章は残っています。閉じる前に再試行するか、文章をコピーしてください。','Could not save. Your text is still on this page. Retry or copy it before closing.','सहेजा नहीं जा सका। पाठ इस पेज पर है। बंद करने से पहले फिर कोशिश करें या कॉपी करें।','저장하지 못했어요. 글은 이 화면에 남아 있어요. 닫기 전에 다시 시도하거나 복사해 주세요.','未能保存。文字仍在本页，关闭前请重试或复制。','No se pudo guardar. El texto sigue en esta página. Reintenta o cópialo antes de cerrar.','Enregistrement impossible. Le texte reste sur cette page. Réessayez ou copiez-le avant de fermer.'],
 retry:['保存を再試行','Retry saving','फिर सहेजें','다시 저장','重试保存','Reintentar','Réessayer'],
 recover:['書きかけを開く','Open draft','अधूरा पाठ खोलें','작성 중인 글 열기','打开草稿','Abrir borrador','Ouvrir le brouillon'],
 next:['次の一歩の下書き','Next-step draft','अगले कदम का मसौदा','다음 단계 초안','下一步草稿','Borrador del siguiente paso','Brouillon du prochain pas'],
 resume:['再開メモの下書き','Resume-note draft','फिर शुरू करने के नोट का मसौदा','재개 메모 초안','继续时的备注草稿','Borrador de la nota para retomar','Brouillon de la note de reprise'],
