...
const PROTOTYPE_TEXT={
 interrupted:['途中の一歩を残してあります。','You stopped here last time.','आपका अधूरा कदम सुरक्षित है।','하던 한 걸음을 남겨 두었어요.','已保留你中途停下的一步。','Tu paso pendiente está guardado.','Votre pas en cours est conservé.'],
 resume:['再開する','Resume','फिर शुरू करें','다시 시작','继续','Retomar','Reprendre'],
 recorded:['この一歩を記録しました。','Step marked done.','यह कदम दर्ज हो गया है।','이 한 걸음을 기록했어요.','已记录这一步。','Este paso quedó registrado.','Ce pas est enregistré.'],
 rest_saved:['ここまでを残しました。いつでも戻れます。','Your progress is saved. Come back whenever you’re ready.','यहाँ तक सहेज लिया है। जब चाहें लौट सकते हैं।','여기까지 남겼어요. 언제든 돌아올 수 있어요.','已保存到这里，随时可以回来。','Guardado hasta aquí. Puedes volver cuando quieras.','C’est enregistré. Vous pouvez revenir quand vous voulez.'],
 optional:['必要なら編集する','Notes and task options','चाहें तो बदलें','필요하면 수정','需要时编辑','Editar si quieres','Modifier si besoin'],
 next_edit:['次の一歩を書く','Add a next step','अगला कदम लिखें','다음 한 걸음 쓰기','写下下一步','Escribir el siguiente paso','Écrire le prochain pas'],
 ...
 reentry:['取りかかり直す入口','A small step to get started again','फिर शुरू करने का एक रास्ता','다시 시작하는 한 걸음','重新开始的入口','Un paso para volver a empezar','Un pas pour recommencer'],
 change_time:['時間を変更','Timer options','समय बदलें','시간 변경','调整时间','Cambiar tiempo','Changer la durée'],
 started:['開始','Started','शुरू किया','시작','已开始','Iniciado','Démarré'],
 neutral:['一歩をここに置いておけます。','One step at a time. You can change this suggestion.','आप एक कदम यहाँ रख सकते हैं।','한 걸음을 여기에 남겨 둘 수 있어요.','可以把一步留在这里。','Puedes dejar un paso aquí.','Vous pouvez garder un pas ici.'],
 smallest:['合わなければ、この一歩を変えられます。','If this doesn’t work for you, try a different step.','यह ठीक न लगे तो कदम बदल सकते हैं।','맞지 않으면 이 한 걸음을 바꿀 수 있어요.','不合适的话，可以换一种做法。','Si no encaja, puedes cambiar este paso.','Si cela ne convient pas, vous pouvez changer ce pas.'],
 empty:['記録はここに残ります。','The steps you start will appear here.','आपके रिकॉर्ड यहाँ रहेंगे।','기록은 여기에 남아요.','记录会保存在这里。','Tus registros aparecerán aquí.','Vos traces apparaîtront ici.'],
 split_edit:['分け方を調整する','Change how these tasks are separated','विभाजन बदलें','나누는 방식 조정','调整分法','Ajustar la separación','Ajuster la séparation']
};
